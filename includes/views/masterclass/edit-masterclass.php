...
<div class="container mt-5">
    ...
    <form method="POST" action="" class="needs-validation" novalidate enctype="multipart/form-data">
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="nombreMasterclass" name="nombreMasterclass"
                value="<?php echo esc_attr($masterclass->nombreMasterclass); ?>" required>
            <div class="invalid-feedback">Este campo es obligatorio.</div>
        </div>

        <div class="mb-3">
            <label for="slugMasterclass" class="form-label">Slug de la Masterclass</label>
            <input type="text" class="form-control" id="slugMasterclass" name="slugMasterclass"
                value="<?php echo $masterclass->slugMasterclass; ?>" required>
        </div>

        <div class="mb-3">
            <label for="hora_inicio" class="form-label">Hora de Inicio:</label>
            <input type="time" class="form-control" id="hora_inicio" name="hora_inicio"
                value="<?php echo esc_attr($masterclass->hora_inicio); ?>" required>
            <div class="invalid-feedback">Este campo es obligatorio.</div>
        </div>
        ...
        <div class="mb-3">
            ...
            <input type="date" class="form-control" id="fecha_inicio" name="fecha_inicio"
                value="<?php echo esc_attr($masterclass->fecha_inicio); ?>" required>
            <div class="invalid-feedback">Este campo es obligatorio.</div>
        </div>

        <div class="mb-3">
            <label for="link_inscripcion" class="form-label">Link de Inscripción:</label>
            <input type="url" class="form-control" id="link_inscripcion" name="link_inscripcion"
                value="<?php echo esc_attr($masterclass->link_inscripcion); ?>" required>
            <div class="invalid-feedback">Este campo es obligatorio.</div>
        </div>
        ...
        <div class="mb-3">
            ...
            <img src="<?php echo esc_url($masterclass->img_masterclass); ?>" alt="Imagen de la Masterclass"
                style="max-width: 100px; margin-top: 10px;">
            <?php endif; ?>
            <!-- Campo oculto para conservar la imagen existente -->
            <input type="hidden" name="existing_img_masterclass"
                value="<?php echo esc_attr($masterclass->img_masterclass); ?>">
        </div>
